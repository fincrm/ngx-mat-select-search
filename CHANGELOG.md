...
- Update compatibility to `@angular/material@16` with `MatLegacySelectModule` (`@angular/material/legacy-select`).

  **Breaking Change**: `@angular/material`: `<= 15` is not supported anymore, please use version `6.0.0`.
